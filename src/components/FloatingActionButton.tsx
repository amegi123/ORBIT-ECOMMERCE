  ...
  return (
    <>
      {/* ─────────────────────────────────────────
          ...
          ───────────────────────────────────────── */}
      <div className={`fixed ${bottomPosition} right-4 md:right-8 z-50 flex flex-col items-end gap-3 font-sans select-none pointer-events-none transition-all duration-300`}>
